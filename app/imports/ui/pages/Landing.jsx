  ...
  render() {
    return (
      <div className='digits-landing-background'>
        <Grid container stackable centerd columns={3}>

          <Grid.Column textAlign='center'>
            <Icon size='huge' name='users' inverted/>
            <Header as='h1' inverted>Multiple Users</Header>
            <Header as='h3' inverted>This address book enables any number of
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header as='h3' inverted>For each contact you can save their name,
              address, and phone number.</Header>
          </Grid.Column>
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header as='h3' inverted>Each time you make contact with a contact,
              ...
              This note is saved along with the timestamp of the contact.</Header>
          </Grid.Column>
